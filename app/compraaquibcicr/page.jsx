    ...
    return (
        ...
        <main className="text-center">
            ...
            <section className=" text-center mt-20 mb-24 max-w-screen-lg mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0 my-10 text-center m-4 font-medium text-lg">
                    ...
                    <div>
                        ...
                        <div className=" text-left mx-8 text-lg md:text-xl duration-300 ease-in-out block">
                            ...
                            <p className="grid grid-cols-2 text-[#00b6e8] border-dotted border-t-2 md:border-y-2 border-black border-opacity-30"><span className="inline-block text-left">Moto</span> <span className="inline-block text-right">$46.000</span></p>
                        </div>
                    </div>
                ...
                <p className=" text-center m-8 px-8 max-w-screen-sm mx-auto"><Boton enlace="https://soapweb.bciseguros.cl/web/DatosVehiculo?Convenios=EBE95AA36E47B33FD608C5BFE58844B6" texto='Paga to SOAP aquí' /></p>
            </section>
